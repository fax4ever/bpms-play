...
public class SelectionProcessTest extends JbpmJUnitBaseTestCase {
	...
	public void before() {
		...
		createRuntimeManager("it/redhat/demo/v3/selection-process.bpmn2");
	...
	public void test_reject() {
		...
		assertNodeTriggered(pi.getId(), "StartProcess", "HR Interview", "Verify HR", "Rejected");
	...
	public void test_promoted_rejected() {
		...
		assertNodeTriggered(pi.getId(), "StartProcess", "HR Interview", "Verify HR", "MGMT Interview");
		assertProcessInstanceActive(pi.getId());

...
public class BusinessAdminProcessTest extends JbpmJUnitBaseTestCase {
	...
	public BusinessAdminProcessTest() {
		super(true, true);
	}

	@Before
	public void before() {
		runtimeManager = createRuntimeManager(IT_REDHAT_DEMO + "business-admin.bpmn2");
	...
	public void run() {
		...
		Map<String, List<VariableInstanceLog>> variables = auditService.findVariableInstances(pi.getId())
			.stream()
